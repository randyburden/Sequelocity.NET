...
";
            ...
            // Act
            var rowsAffected = await Sqlocity.GetDatabaseCommand(ConnectionStringsNames.PostgreSQLConnectionString)
                .SetCommandText(sql)
...
";
        ...
        public async void Should_Call_The_DatabaseCommandPreExecuteEventHandler()
        {
            ...
            // Act
            await Sqlocity.GetDatabaseCommandForMySql(ConnectionStringsNames.PostgreSQLConnectionString)
