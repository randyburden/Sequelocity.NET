...
";
            ...
            // Act
            var rowsAffectedTask = Sqlocity.GetDatabaseCommand( ConnectionStringsNames.MySqlConnectionString )
                .SetCommandText( sql )
...
";
        ...
        public void Should_Call_The_DatabaseCommandPreExecuteEventHandler()
        {
            ...
            // Act
            Sqlocity.GetDatabaseCommandForMySql( ConnectionStringsNames.MySqlConnectionString )
