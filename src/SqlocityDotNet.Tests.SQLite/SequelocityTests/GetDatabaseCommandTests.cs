...
namespace SqlocityNetCore.Tests.SQLite.SequelocityTests
{
    ...
    public class GetDatabaseCommandTests
    {
        ...
        public void Can_Get_A_DatabaseCommand_By_Setting_A_Default_ConnectionString_Name()
        {
            ...
            Sqlocity.ConfigurationSettings.Default.ConnectionStringName = ConnectionStringsNames.SqliteInMemoryDatabaseConnectionString;
        ...
        public void Can_Get_A_DatabaseCommand_By_Setting_A_Default_ConnectionString_And_A_DbProviderFactoryInvariantName()
        {
            ...
            Sqlocity.ConfigurationSettings.Default.ConnectionString = ConfigurationManager.ConnectionStrings[ ConnectionStringsNames.SqliteInMemoryDatabaseConnectionString ].ConnectionString;
            Sqlocity.ConfigurationSettings.Default.DbProviderFactoryInvariantName = "System.Data.SQLite";
