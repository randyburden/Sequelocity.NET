...
";
            ...
            // Act
            var superHeroIdTask = Sqlocity.GetDatabaseCommandForSQLite(ConnectionStringsNames.SqliteInMemoryDatabaseConnectionString)
                .SetCommandText(sql)
                .ExecuteScalarAsync();
...
";
            ...
            // Act
            var superHeroIdTask = Sqlocity.GetDatabaseCommand(ConnectionStringsNames.SqliteInMemoryDatabaseConnectionString)
                .SetCommandText(sql)
