...
namespace SqlocityNetCore.Tests.DatabaseCommandExtensionsTests
{
    ...
    public class GenerateInsertsForSQLiteTests
    {
        ...
        public void Should_Generate_Insert_Statements_When_Passed_An_List_Of_Instantiated_Objects()
        {
            ...
            // Act
            databaseCommand = databaseCommand.GenerateInsertsForSQLite( list );
        ...
        public void Should_Use_The_Supplied_Table_Name_In_The_Insert_Statements()
        {
            ...
            // Act
            databaseCommand = databaseCommand.GenerateInsertsForSQLite( list, "[Person]" );
        ...
        public void Should_Throw_An_Exception_When_Passing_An_Anonymous_Object_And_Not_Specifying_A_TableName()
        {
            ...
            // Act
            TestDelegate action = () => databaseCommand.GenerateInsertsForSQLite( list );
